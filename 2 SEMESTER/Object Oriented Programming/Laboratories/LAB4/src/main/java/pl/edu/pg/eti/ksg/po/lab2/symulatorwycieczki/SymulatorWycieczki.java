...
public class SymulatorWycieczki {
    ...
    public SluchaczPostepow klasaAnonimowa()
    {
        return new SluchaczPostepow() {
            @Override
            public void aktualizujPostep(ElementWycieczki elementWycieczki, int lp, int liczbaElementow) {
                System.out.println("####### POSTĘP PODRÓŻY ########");
                System.out.println("==> " + (lp+1) + " / " + liczbaElementow + " <== ");
            }
        };
    }
